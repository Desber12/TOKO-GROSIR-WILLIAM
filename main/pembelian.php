...
if ($transaksi_id == 0) {
    echo "<script>alert('ID transaksi tidak valid!'); window.location.href='penjualan.php';</script>";
    exit;
}
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="invoice-container">
            ...
            <a href="../main/produk.php" class="btn-back"><i class="fas fa-arrow-left"></i> Kembali ke Toko</a>
        </div>
    </div>  
